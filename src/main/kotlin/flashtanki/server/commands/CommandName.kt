...
enum class CommandName(val category: CommandCategory, val key: String, val side: CommandSide) {
  ...
  SetEntranceHash(CommandCategory.Auth, "set_entrance_hash", CommandSide.Client),
  ...
  ConfirmVote(CommandCategory.Battle, "confirm_vote", CommandSide.Client),
  ...
  UpdateRating(CommandCategory.Lobby, "update_rating", CommandSide.Client),
  ...
  ShowBonusesPresent(CommandCategory.Lobby, "show_bonuses_present", CommandSide.Client),
  ...
  InitJgrModel(CommandCategory.Battle, "init_jgr_model", CommandSide.Client),
  ...
  BattleMessage(CommandCategory.Battle, "battle_message", CommandSide.Client),
  ...
  KillStreakAchived(CommandCategory.Battle, "killStreakAchived", CommandSide.Client),
  ...
  TankCapturingPointServer(CommandCategory.Battle, "tank_capturing_point", CommandSide.Server),
  TankLeaveCapturingPointServer(CommandCategory.Battle, "tank_leave_capturing_point", CommandSide.Server),
  TankCapturingPoint(CommandCategory.Battle, "tank_capturing_point", CommandSide.Client),
  TankLeaveCapturingPoint(CommandCategory.Battle, "tank_leave_capturing_point", CommandSide.Client),
  SetPoinScore(CommandCategory.Battle, "set_point_score", CommandSide.Client),
  PointCapturedBy(CommandCategory.Battle, "point_captured_by", CommandSide.Client),
  PointLostBy(CommandCategory.Battle, "point_lost_by", CommandSide.Client),
  PointCaptureStarted(CommandCategory.Battle, "pointCaptureStarted", CommandSide.Client),
  PointCaptureStopped(CommandCategory.Battle, "pointCaptureStopped", CommandSide.Client),
  ...
  /* Flamethrower/Frezee temperature */
  ...
  AddOneGoldRegion(CommandCategory.Battle, "addOneGoldRegion", CommandSide.Client),
  RemoveOneGoldRegion(CommandCategory.Battle, "removeOneGoldRegion", CommandSide.Client),
  AddBonusRegion(CommandCategory.Battle, "addBonusRegion", CommandSide.Client),
   ...
   */
  ShowPresentsAlert(CommandCategory.Lobby, "showNewPresentsAlert", CommandSide.Client),
  ShowPresents(CommandCategory.Lobby, "showPresents", CommandSide.Server),
  ...
  TryActivatePromocode(CommandCategory.Lobby, "try_activate_promocode", CommandSide.Server),
  ActivatePromocodeSuccessfully(CommandCategory.Lobby, "activate_promocode_successfully", CommandSide.Client),
  ActivatePromocodeFailed(CommandCategory.Lobby, "activate_promocode_failed", CommandSide.Client),
  ValidateUID(CommandCategory.Lobby, "validateUid", CommandSide.Server),
  ValidateResult(CommandCategory.Lobby, "validateResult", CommandSide.Client),
  ...
  ClientOpenQuestsWithoutQuests(CommandCategory.Lobby, "showQuestWindowWithoutDailyQuests", CommandSide.Client),
  ...
  ClanNotExist(CommandCategory.Clan, "clanNotExist", CommandSide.Client),
  СlanTagNotExist(CommandCategory.Clan, "clanTagNotExist", CommandSide.Client),
  СlanTagExist(CommandCategory.Clan, "clanTagExist", CommandSide.Client),
