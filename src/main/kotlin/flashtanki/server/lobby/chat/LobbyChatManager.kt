...
class LobbyChatManager : ILobbyChatManager, KoinComponent {
  ...
  private val yellowText: MutableList<String> = mutableListOf(		"Логин и пароль от аккаунта - это ключ от вашего танка. Нельзя вводить их где-то, кроме формы входа в игру. Ежедневно злоумышленники угоняют сотни аккаунтов честных танкистов, из-за их халатного обращения с логином и паролем. Будьте внимательны!",
          ...
          "Танкисты и танкистки, вы пользуйтесь социальной сетью ВКонтакте? Тогда обязательно привяжите свой аккаунт в \"Танках Онлайн\" к ней! Вы получаете простоту входа в игру и безопасность аккаунта всего за пару минут. Ищите кнопку \"ВКонтакте\" в игровых Настройках.",
          ...
          "Дорогие игроки, не поддавайтесь на обман мошенников, которые пытаются предложить вам платные услуги в \"Танках Онлайн\". Сотрудники службы технической поддержки НИКОГДА не предлагают платных услуг. За реальные деньги можно купить ТОЛЬКО кристаллы и ТОЛЬКО в самой игре в платежном разделе.",
          "Если у вас возникли проблемы с платежом, либо вы потеряли контроль над своим аккаунтом - обратитесь в нашу службу технической поддержки, написав электронное письмо по адресу help@tankionline.com.",
          ...
          "Танкисты! Газета ТО теперь в новом формате - читайте интересные статьи и рассказы в специальном разделе #battle49175@форума@#8.",
          "«Танки Онлайн» теперь и в Одноклассниках! Интересные конкурсы, арты и видео, впечатления танкистов об игре - всё это вы найдёте в нашей#battle43373@группе@#8.",
